...
async function main() {
    ...
    program
        .name('stellar-matter-cli')
        .description('Stellar Matter CLI — read-only LIS Sample Worksheet navigation (no worksheet writes). Originally lis-nav-bot, renamed in Phase 11.')
